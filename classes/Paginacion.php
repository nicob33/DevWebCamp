...
class Paginacion {
    ...
    {
        $this->pagina_actual = (int) $pagina_actual; //Con (int) lo estamos casteando para que si viene un string, lo transforme a un entero
    ...
    public function total_paginas() {
        return ceil($this->total_registros / $this->registros_por_pagina); //ceil redondea para arriba
    }

    //Metodo para ir la pagina anterior
    public function pagina_anterior() {
        $anterior = $this->pagina_actual - 1;
        return ($anterior > 0) ? $anterior : false;
    }

    //Metodo para ir la pagina siguiente
